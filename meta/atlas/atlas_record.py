...
REQUIRED_BLOCKS = (
    "schema_version", "id", "source", "nabla", "periodic15", "atom_stack",
    "evidence_receipts", "edges", "bridges", "anchors", "reality_mirror",
...
def validate_record(record: dict[str, Any]) -> list[str]:
    ...
    if state not in {"Candidate", "Admitted", "Refused", "UNKNOWN"}:
