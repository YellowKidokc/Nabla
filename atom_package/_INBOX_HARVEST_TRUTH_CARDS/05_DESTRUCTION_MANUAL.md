...
## The Destruction Manual for Hubble Gradient
...
| # | Attack | Source Paper | What Breaks | Severity | Status |
|---|--------|-------------|-------------|----------|--------|
| 1 | | Paper I | | Critical / Serious / Minor | |
| 2 | | Paper I | | | |
| 3 | | Paper II | | | |
| 4 | | Paper III | | | |
| 5 | [New — identified during synthesis] | Cross-paper | | | |
...
> [!danger] Terminal Kill Conditions
> If ANY of these are satisfied, the thesis fails as a whole. Not a paper. The whole thing.

1. [Terminal condition 1]
2. [Terminal condition 2]
3. [Terminal condition 3]
...
```
Thesis Unit: DT-004
Section: Destruction Manual
Total Kill Conditions: [N]
Terminal Kill Conditions: [N]
Open Vulnerabilities: [N]
Honest Assessment: [How defensible overall?]
```
